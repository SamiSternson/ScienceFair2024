...
data1 = pd.read_csv("C:/Users/scott/OneDrive/Desktop/ScienceFair_2024/box/box1.csv")
...
control_stdm = []
covered_stdm = []
control_slope = linregress(time * 1, control)
covered_slope = linregress(time * 1, covered)
